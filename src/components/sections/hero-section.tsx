      ...
      <div className="mx-auto flex max-w-6xl flex-col gap-16 px-6 sm:px-8">
        ...
        >
          ...
          <motion.div
            ...
            className="relative overflow-hidden rounded-[28px] border border-white/10 bg-white/5 shadow-[0_40px_80px_-40px_rgba(24,149,255,0.45)] backdrop-blur-xl"
          >
            <div className="relative h-72 w-full overflow-hidden">
              ...
              <div className="absolute left-5 right-5 bottom-5 space-y-2 text-white">
                <span className="inline-flex items-center gap-2 rounded-full border border-white/20 bg-white/10 px-3 py-1 text-[11px] uppercase tracking-[0.32em] text-white/80">
                  Portafolio destacado
                </span>
                <h3 className="text-lg font-semibold">{propertyPreview.title}</h3>
            ...
            <div className="space-y-5 p-6">
              <div className="flex flex-wrap items-center gap-4">
                ...
                <div>
                  ...
                  <p className="mt-1 text-sm text-white/80">{propertyPreview.area}</p>
                </div>
              </div>
              <div className="rounded-2xl border border-white/10 bg-black/20 px-4 py-3 text-xs text-muted-foreground">
                {propertyPreview.availability}
              </div>
              <div className="grid gap-3 sm:grid-cols-3">
                {propertyPreview.stats.map((stat) => (
                  <div
                    key={stat.label}
